...
#ifdef FORWARD
const int MotorLF1 = Motors[7];
const int MotorLF2 = Motors[6];
const int MotorLB1 = Motors[4];
const int MotorLB2 = Motors[5];
const int MotorRB1 = Motors[1];
const int MotorRB2 = Motors[0];
